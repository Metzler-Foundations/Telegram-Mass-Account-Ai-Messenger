...
class IntelligenceEngine:
    ...
    async def gather_user_intelligence(
        self, client: Client, user_id: int, deep_analysis: bool = False
    ...
    def _calculate_value_score(self, intel: UserIntelligence) -> float:
        ...
        completeness = sum(
            [bool(intel.username), bool(intel.first_name), bool(intel.bio), bool(intel.phone)]
        )
    ...
    def get_top_value_users(
        self, limit: int = 100, min_score: float = 50.0
    ...
    def get_user_statistics(self) -> Dict[str, Any]:
        ...
        cursor.execute(
            "SELECT activity_level, COUNT(*) FROM user_intelligence GROUP BY activity_level"
        )
