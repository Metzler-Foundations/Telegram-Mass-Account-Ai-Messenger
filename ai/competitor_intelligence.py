...
class CompetitorIntelligence:
    ...
    def add_competitor(self, user_id: int, username: str = None, 
        ...
        cursor.execute("""
            ...
            VALUES (?, ?, ?, ?, ?, ?)
        """, (competitor_id, user_id, username, display_name, 
    ...
    def find_target_overlap(self, our_targets: List[int], 
                           competitor_id: str) -> List[int]:
