...
class DistributedScrapingCoordinator:
    ...
    def __init__(self, anti_detection_system: EliteAntiDetectionSystem, performance_profile: Optional[Dict[str, Any]] = None):
        ...
        self.max_concurrent_workers = base_workers
        self.worker_idle_sleep = perf_scraping.get("queue_poll_interval", 0.1)
        if self.low_power:
            self.worker_idle_sleep = max(self.worker_idle_sleep, 0.3)
    ...
    async def _worker_loop(self):
        ...
        while True:
            try:
                ...
                await asyncio.sleep(self.worker_idle_sleep)
...
class EliteMemberScraper:
    ...
    def __init__(self, db: MemberDatabase, anti_detection: EliteAntiDetectionSystem,
        ...
        Args:
            ...
            data_extractor: Comprehensive data extractor
            client: Optional Pyrogram client (can be set later via .client attribute)
        """
        self.db = db
        self.anti_detection = anti_detection
        self.data_extractor = data_extractor
        self.client = client  # Primary client for scraping operations
