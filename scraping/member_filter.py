...
from PyQt6.QtWidgets import (
    ...
    QCheckBox, QSpinBox, QDateEdit, QComboBox, QGroupBox, QFormLayout,
...
class MemberFilterDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        self.lang_combo.addItems([
            "All Languages", "English", "Spanish", "French", "German",
        ...
        self.results_label.setStyleSheet("padding: 10px; background-color: #2b2d31; border-radius: 4px;")
    ...
    def preview_results(self):
        ...
        if not criteria:
            QMessageBox.information(
                self,
                "No Filters",
                "No filters selected. All members will be included."
            )
            return
