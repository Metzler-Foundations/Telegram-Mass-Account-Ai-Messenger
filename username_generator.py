...
class UsernameGenerator:
    ...
    def generate_visually_similar_username(self, source_username: str, 
                                          max_attempts: int = 50) -> Optional[str]:
        """
    ...
    async def find_available_similar_username(self, client, source_username: str, 
        ...
        while attempts < max_attempts:
            ...
            if is_available:
                logger.info(f"✅ Found available similar username: {candidate} (from {source_username})")
                return candidate
            else:
        ...
        logger.warning(f"Could not find available similar username for {source_username} after {max_attempts} attempts")
        return None
