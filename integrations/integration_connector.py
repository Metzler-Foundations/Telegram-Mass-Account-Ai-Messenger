    ...
    async def create_account_with_tracking(self, config: Dict) -> Dict:
        ...
        try:
            ...
            save_operation_checkpoint(
                operation_id, "account_creation", 0, 100, {"config": config, "stage": "starting"}
            )
...
class CampaignIntegration:
    ...
    async def run_campaign_with_tracking(
...
class MemberScraperIntegration:
    ...
    async def scrape_with_tracking(
        ...
        try:
            ...
            # Save checkpoint
            save_operation_checkpoint(
                operation_id, "member_scraping", 0, 100, {"channel": channel_username}
            )
            ...
            return {"success": True, "members_count": saved_count, "channel": channel_username}
...
class AnalyticsIntegration:
    ...
    def get_dashboard_metrics() -> Dict:
        ...
        try:
            ...
            return {
                "members": {"total": member_count, "channels": len(channels)},
                "accounts": {
