...
class NetworkTimeoutHandler:
    ...
    def configure_aiohttp_session(self, session_kwargs: dict, operation_type: str = 'http_request') -> dict:
    ...
    def get_statistics(self) -> dict:
        ...
        return {
            **stats_copy,
            ...
            'success_rate': (
                (total_ops - total_timeouts) / total_ops * 100
                if total_ops > 0 else 0.0
            )
        }
...
def with_timeout(operation_type: str):
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(*args, **kwargs):
            ...
            return await handler.execute_with_timeout_async(
...
def with_timeout_sync(operation_type: str):
    ...
    def decorator(func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs):
            handler = get_timeout_handler()
            return handler.execute_with_timeout(
                func, operation_type, *args, **kwargs
            )
        return wrapper
    return decorator
