...
class MediaValidator:
    ...
    def validate_image(image_path: str) -> tuple:
        ...
        try:
            # Check size first
            valid, msg = MediaValidator.validate_file_size(
                image_path, MediaValidator.MAX_IMAGE_SIZE
            )
            if not valid:
                return False, msg
            ...
            with Image.open(image_path) as img:
                ...
                # Check dimensions
                if (
                    img.width > MediaValidator.MAX_IMAGE_DIMENSIONS[0]
                    or img.height > MediaValidator.MAX_IMAGE_DIMENSIONS[1]
                ):
