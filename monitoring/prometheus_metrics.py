...
class MetricsCollector:
    ...
    def __init__(self):
        ...
        # Histograms
        self.message_send_duration = Histogram('message_send_duration_seconds', 'Message send duration')
        self.api_call_duration = Histogram('api_call_duration_seconds', 'API call duration', ['endpoint'])
