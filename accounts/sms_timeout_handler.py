...
class SMSTimeoutHandler:
    ...
    def __init__(
        self, timeout_seconds: int = 300, max_retries: int = 3, code_expiry_seconds: int = 600
    ):
        self.timeout_seconds = timeout_seconds
        self.max_retries = max_retries
        self.code_expiry_seconds = (
            code_expiry_seconds  # Telegram codes typically expire after 10 min
        )
    ...
    async def wait_for_code(
        ...
        while attempts < self.max_retries:
            ...
            try:
                ...
                code = await asyncio.wait_for(retrieve_func(phone_number), timeout=actual_timeout)
                ...
                if attempts < self.max_retries:
                    ...
                    logger.warning(
                        f"Code retrieval attempt {attempts} failed, retrying in {wait_time}s..."
                    )
                ...
                if (
                    ...
                    and elapsed_since_request < self.code_expiry_seconds
                ):
