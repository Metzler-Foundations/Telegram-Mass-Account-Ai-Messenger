...
def test_imports():
    ...
    # Test individual components without main.py
    modules_to_test = [
        ('telegram_client', 'TelegramClient'),
        ('gemini_service', 'GeminiService'),
        ('account_creator', 'AccountCreator'),
        ('member_scraper', 'MemberDatabase'),
        ('anti_detection_system', 'AntiDetectionSystem')
    ]
    ...
    for module_name, class_name in modules_to_test:
        try:
            ...
            print(f"✅ {module_name}.py imports successful")
    ...
    try:
        ...
        print("✅ telegram_client.py imports successful")
    except Exception as e:
        print(f"❌ telegram_client.py import failed: {e}")
        return False

    try:
        from gemini_service import GeminiService
        print("✅ gemini_service.py imports successful")
    except Exception as e:
    ...
    try:
        ...
        print("✅ account_creator.py imports successful")
    except Exception as e:
        print(f"❌ account_creator.py import failed: {e}")
        return False

    try:
        from member_scraper import MemberDatabase
        print("✅ member_scraper.py imports successful")
    except Exception as e:
        print(f"❌ member_scraper.py import failed: {e}")
        return False

    try:
        from anti_detection_system import AntiDetectionSystem
        print("✅ anti_detection_system.py imports successful")
    except Exception as e:
        print(f"❌ anti_detection_system.py import failed: {e}")
        return False
