    ...
    def setup_ui(self):
        ...
        if MATPLOTLIB_AVAILABLE:
            ...
            no_chart_label = QLabel(
                "Risk distribution charts require matplotlib.\nInstall with: pip install matplotlib"
            )
        ...
        self.avg_risk_label.setStyleSheet(
            f"color: {chart_colors['text_secondary']}; font-size: 14px; font-weight: 500;"
        )
        stats_layout.addWidget(self.avg_risk_label)

        self.quarantine_label = QLabel("Quarantine: 0")
        self.quarantine_label.setStyleSheet(
            f"color: {chart_colors['danger']}; font-size: 14px; font-weight: 500;"
        )
