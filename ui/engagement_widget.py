        ...
        try:
            ...
            for row, rule in enumerate(rules):
                ...
                enabled_check.stateChanged.connect(
                    lambda state, rule_id=rule.rule_id: self.toggle_rule_enabled(
                        rule_id, state == Qt.CheckState.Checked.value
                    )
                )
        ...
        if rule.target_groups:
            ...
            for group_id in rule.target_groups:
                ...
                toggle_btn.clicked.connect(
                    lambda checked, gid=group_id, rule=rule: self.toggle_group_for_rule(
                        rule.rule_id, gid, dialog
                    )
                )
            ...
            try:
                ...
                if self.engagement_automation:
                    ...
                    QMessageBox.information(
                        self, "Success", f"Rule '{rule.name}' created successfully!"
                    )
        ...
        if dialog.exec() == QDialog.DialogCode.Accepted:
            ...
            try:
                ...
                if self.engagement_automation:
                    ...
                    self.refresh_data()
                    QMessageBox.information(
                        self, "Success", f"Rule '{updated_rule.name}' updated successfully!"
                    )
