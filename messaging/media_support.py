...
class MediaSupport:
    ...
    async def send_video(client, chat_id: str, video_path: str, caption: str = None):
        ...
        try:
            await client.send_video(chat_id=chat_id, video=video_path, caption=caption)
    ...
    async def send_audio(client, chat_id: str, audio_path: str, caption: str = None):
        ...
        try:
            await client.send_audio(chat_id=chat_id, audio=audio_path, caption=caption)
    ...
    async def send_animation(client, chat_id: str, animation_path: str):
        """Send GIF/animation."""
        try:
            await client.send_animation(chat_id=chat_id, animation=animation_path)
