...
from PyQt6.QtWidgets import (
    ...
    QMessageBox, QProgressBar, QRadioButton, QButtonGroup, QLineEdit
)
...
class DataExportDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        self.status_label.setStyleSheet("padding: 10px; background-color: #2b2d31; border-radius: 4px;")
    ...
    def setup_member_options(self, parent_layout):
        ...
        self.include_phone_check.setToolTip("Phone numbers are rarely available for scraped members")
    ...
    def update_status(self):
        ...
        if self.file_path_edit.text():
            ...
            self.status_label.setText(
                f"⚠️ Choose a save location to continue"
            )
...
def export_members_from_database(filter_criteria: Dict = None, format: str = "csv", file_path: str = None) -> bool:
