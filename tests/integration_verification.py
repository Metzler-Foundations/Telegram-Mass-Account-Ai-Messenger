...
class IntegrationVerifier:
    ...
    def test_background_services_start(self):
        ...
        try:
            ...
            assert hasattr(
                MainWindow, "_start_background_services"
            ...
            assert (
                "_initialize_services" in source or "_start_background_services" in source
    ...
    def test_analytics_widgets(self):
        ...
        try:
            ...
            assert hasattr(
                CampaignAnalyticsWidget, "export_analytics"
            ), "CampaignAnalyticsWidget missing export_analytics"

            assert hasattr(
                DeliveryAnalyticsWidget, "export_data"
            ), "DeliveryAnalyticsWidget missing export_data"

            assert hasattr(
                AnalyticsDashboard, "export_dashboard_data"
    ...
    def test_charts(self):
        ...
        try:
            ...
            assert hasattr(
                RiskDistributionChart, "refresh_chart"
            ), "RiskDistributionChart missing refresh_chart"
            assert hasattr(
                RiskDistributionChart, "get_risk_data"
            ), "RiskDistributionChart missing get_risk_data"
    ...
    def test_tooltips(self):
        ...
        try:
            ...
            if tooltip_count >= 5:
                self.passed.append(
                    f"✅ Tooltips implemented ({tooltip_count} found in campaign dialog)"
                )
            else:
    ...
    def test_template_variants(self):
        ...
        try:
            ...
            assert (
                "_add_variant_row" in source or "Template Variants" in source
            ...
            assert (
                "template_variants" in get_data_source
