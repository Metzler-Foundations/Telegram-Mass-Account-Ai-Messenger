...
def create_test_account(
    phone_number: str = "+1234567890", status: str = "active", **kwargs
) -> Dict[str, Any]:
...
def create_test_member(user_id: int = None, **kwargs) -> Dict[str, Any]:
...
def create_test_campaign(campaign_id: int = None, **kwargs) -> Dict[str, Any]:
