...
from PyQt6.QtWidgets import (
    ...
    QFrame, QGroupBox, QAbstractItemView
)
...
class WarmupProgressWidget(QWidget):
    ...
    def refresh_warmup_status(self):
        ...
        try:
            ...
            logger.debug(f"Refreshed warmup status: {in_progress} in progress, {completed} completed")
...
def update_warmup_progress(phone_number: str, stage: str, progress: float, 
