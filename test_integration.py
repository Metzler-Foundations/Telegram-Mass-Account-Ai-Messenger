...
from services import BusinessLogicCoordinator
...
class TestUIControllerIntegration:
    ...
    def ui_controller(self):
        ...
        with patch('ui_controller.BusinessLogicCoordinator') as mock_coordinator_class:
    ...
    def test_create_campaign_success_workflow(self, ui_controller):
        ...
        ui_controller.business_logic.campaign_service.validate_campaign_data.assert_called_once_with(campaign_data)
        ui_controller.business_logic.campaign_service.create_campaign.assert_called_once_with(campaign_data)
    ...
    def test_get_members_for_campaign_workflow(self, ui_controller):
        ...
        mock_metrics = {
            'total_members': 2,
            'avg_profile_quality': 0.7
        }

        ui_controller.business_logic.member_service.filter_members_for_campaign.return_value = mock_members
        ui_controller.business_logic.member_service.calculate_campaign_metrics.return_value = mock_metrics
